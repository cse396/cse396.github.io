...
"background:  transparent;} ")
        ...
        self.Button_Mapping.setGeometry(QtCore.QRect(405, 600, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        self.Button_Mapping.setFont(font)
        self.Button_Mapping.setStyleSheet("font: 10pt \"Arial\";")
        ...
        self.Button_TextDetect = QtWidgets.QPushButton(client)
        self.Button_TextDetect.setGeometry(QtCore.QRect(155, 600, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        self.Button_TextDetect.setFont(font)
        self.Button_TextDetect.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_TextDetect.setObjectName("Button_TextDetect")
        self.Button_ObjectDetect = QtWidgets.QPushButton(client)
        self.Button_ObjectDetect.setGeometry(QtCore.QRect(250, 600, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        self.Button_ObjectDetect.setFont(font)
        self.Button_ObjectDetect.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_ObjectDetect.setObjectName("Button_ObjectDetect")
        self.Button_ImageProcess = QtWidgets.QPushButton(client)
        self.Button_ImageProcess.setGeometry(QtCore.QRect(205, 600, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        self.Button_ImageProcess.setFont(font)
        self.Button_ImageProcess.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_ImageProcess.setObjectName("Button_ImageProcess")
        self.Button_SaveToMap = QtWidgets.QPushButton(client)
        self.Button_SaveToMap.setGeometry(QtCore.QRect(405, 600, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.Button_SaveToMap.setFont(font)
        self.Button_SaveToMap.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_SaveToMap.setObjectName("Button_ForWard")
        ...
        self.label_detected_text = QtWidgets.QLabel(client)
        self.label_detected_text.setGeometry(QtCore.QRect(50, 600, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.label_detected_text.setFont(font)
        self.label_detected_text.setStyleSheet("font: 10pt \"Arial\";")
        self.label_detected_text.setAlignment(QtCore.Qt.AlignCenter)
        self.label_detected_text.setObjectName("label_detected_text")
    ...
    def retranslateUi(self, client):
        ...
        self.Button_TextDetect.setText(_translate("client", "Text Detection"))
        self.Button_ObjectDetect.setText(_translate("client", "Object Detection"))
        ...
        self.Button_SaveToMap.setText(_translate("client", "Save to Map"))
        ...
        self.label_detected_text.setText(_translate("client", "None"))
