...
"padding:5px;\n"
"color:#DCDCDC;\n"
"background:qlineargradient(spread:pad,x1:0,y1:0,x2:0,y2:1,stop:0 #f7a96d,stop:1 #000000);\n"
"}\n"
...
"background:  transparent;} ")
        ...
        self.Video.setGeometry(QtCore.QRect(10, 90, 400, 300))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_Buzzer.setGeometry(QtCore.QRect(1505, 470, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lineEdit_IP_Adress.setGeometry(QtCore.QRect(310, 20, 100, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_Connect.setGeometry(QtCore.QRect(420, 20, 90, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_IMU.setGeometry(QtCore.QRect(6700, 510, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.slider_height.setGeometry(QtCore.QRect(1000, 390, 160, 22))
        self.slider_horizon = QtWidgets.QSlider(client)
        self.slider_horizon.setGeometry(QtCore.QRect(1000, 360, 160, 22))
        self.label_2 = QtWidgets.QLabel(client)
        self.label_2.setGeometry(QtCore.QRect(7000, 390, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_3.setGeometry(QtCore.QRect(7000, 360, 60, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_height.setGeometry(QtCore.QRect(4500, 390, 30, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_horizon.setGeometry(QtCore.QRect(4500, 360, 30, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_Calibration.setGeometry(QtCore.QRect(1045, 380, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(False)
        font.setWeight(50)
        ...
        self.Button_Ball_And_Face.setGeometry(QtCore.QRect(6700, 470, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_Sonic.setGeometry(QtCore.QRect(5550, 510, 90, 30))
        self.Button_Face_ID = QtWidgets.QPushButton(client)
        self.Button_Face_ID.setGeometry(QtCore.QRect(5550, 470, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Button_LED.setGeometry(QtCore.QRect(4400, 510, 90, 30))
        self.label_speed = QtWidgets.QLabel(client)
        self.label_speed.setGeometry(QtCore.QRect(3850, 520, 35, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.slider_speed.setGeometry(QtCore.QRect(3090, 380, 22, 125))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_7.setGeometry(QtCore.QRect(3075, 350, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.slider_head.setGeometry(QtCore.QRect(1000, 420, 160, 22))
        self.label_8 = QtWidgets.QLabel(client)
        self.label_8.setGeometry(QtCore.QRect(7000, 420, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_head.setGeometry(QtCore.QRect(4500, 420, 30, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.progress_Power.setGeometry(QtCore.QRect(310, 50, 200, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_6.setGeometry(QtCore.QRect(7000, 270, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_5.setGeometry(QtCore.QRect(7000, 330, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.slider_yaw.setGeometry(QtCore.QRect(1000, 330, 160, 22))
        self.label_roll = QtWidgets.QLabel(client)
        self.label_roll.setGeometry(QtCore.QRect(4500, 270, 30, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_4.setGeometry(QtCore.QRect(7000, 300, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_pitch.setGeometry(QtCore.QRect(1000, 300, 30, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.slider_pitch.setGeometry(QtCore.QRect(1000, 300, 160, 22))
        self.slider_roll = QtWidgets.QSlider(client)
        self.slider_roll.setGeometry(QtCore.QRect(1000, 270, 160, 22))
        self.label_yaw = QtWidgets.QLabel(client)
        self.label_yaw.setGeometry(QtCore.QRect(1000, 330, 30, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
    ...
    def retranslateUi(self, client):
        ...
        client.setWindowTitle(_translate("client", "CSE396 GROUP-10 ROBODOG GUI"))
